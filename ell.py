...
NIFTY500_TICKERS = [
    ...
    "ABCAPITAL.NS","ABFRL.NS","ABREL.NS","ABSLAMC.NS","AEGISLOG.NS","AFCONS.NS","AFFLE.NS","AJANTPHARM.NS","APLLTD.NS",
    "ALIVUS.NS","ALKYLAMINE.NS","ALOKINDS.NS","ARE&M.NS","AMBER.NS","AMBUJACEM.NS","ANANDRATHI.NS","ANANTRAJ.NS","ANGELONE.NS",
    ...
    "DIXON.NS","LALPATHLAB.NS","DRREDDY.NS","EIDPARRY.NS","EIHOTEL.NS","EICHERMOT.NS","ELECON.NS","ELGIEQUIP.NS","EMAMILTD.NS",
    ...
    "PAGEIND.NS","PATANJALI.NS","PERSISTENT.NS","PETRONET.NS","PFIZER.NS","PHOENIXLTD.NS","PIDILITIND.NS","PPLPHARMA.NS","POLYMED.NS",
    ...
    "SUNDRMFAST.NS","SUPREMEIND.NS","SUZLON.NS","SWIGGY.NS","SYNGENE.NS","SYRMA.NS","TBOTEK.NS","TVSMOTOR.NS","TANLA.NS",
    "TATACHEM.NS","TATACOMM.NS","TCS.NS","TATACONSUM.NS","TATAELXSI.NS","TATAINVEST.NS","TATAPOWER.NS","TATASTEEL.NS","TATATECH.NS",
...
@st.cache_data(show_spinner=False)
def load_history_for_ticker(ticker, period="2y", interval="1d"):
    try:
...
def build_ml_dataset_for_tickers(
    ...
    for t in stqdm(tickers, desc="Preparing ML data"):
        hist = load_history_for_ticker(t, period="2y", interval="1d")
...
def latest_feature_row_for_ticker(ticker, sma_windows, support_window, feature_cols, zz_pct, zz_min_bars):
    hist = load_history_for_ticker(ticker, period="2y", interval="1d")
